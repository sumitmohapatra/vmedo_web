...
@Component({
  selector: 'app-hospital-admission-component',
  templateUrl: './hospital-admission-component.component.html',
  styleUrls: ['./hospital-admission-component.component.css']
})
export class HospitalAdmissionComponentComponent {
